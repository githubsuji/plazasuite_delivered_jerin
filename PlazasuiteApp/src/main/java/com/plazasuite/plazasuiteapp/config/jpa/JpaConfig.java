 ...
 */
package com.plazasuite.plazasuiteapp.config.jpa;
...
@EnableJpaRepositories(basePackages = "com.plazasuite.plazasuiteapp.repositories",
...
public class JpaConfig {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
    ...
    em.setPackagesToScan("com.plazasuite.plazasuiteapp.jpa.entity.beans");
